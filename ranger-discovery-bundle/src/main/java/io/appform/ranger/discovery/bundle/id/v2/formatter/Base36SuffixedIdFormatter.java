...
public class Base36SuffixedIdFormatter implements IdFormatter {
    private static final Pattern PATTERN = Pattern.compile("([A-Za-z]*)([0-9]{2})([A-Z0-9]{16})(.*)");
    private static final Pattern BASE10_PATTERN = Pattern.compile("([0-9]{15})([0-9]{4})([0-9]{3})");
    ...
    public IdParserType getType() {
        return IdParserType.BASE_36_SUFFIXED;
    }
    ...
    public String format(final DateTime dateTime,
                         ...
                         final String suffix) {
        return String.format("%02d%s%s", getType().getValue(),
